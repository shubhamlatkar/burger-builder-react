...
class ContactData extends Component {
    ...
    orderHandler = event => {
        ...
        axios
            .get("/orderId/" + this.state.userId, { headers: { "Access-Control-Allow-Origin": "*" } })
            .then(res => {
                ...
                this.setState({ orderId: res.data }, () => {
                    ...
                    axios
                        .put("/ingredients", ingredients, { headers: { "Access-Control-Allow-Origin": "*" } })
                        .then(res => {
                            console.log(res.data);
                            ...
                            axios
                                .put("/address", address, { headers: { "Access-Control-Allow-Origin": "*" } })
                                .then(res => {
                                    console.log(res.data);
                                    this.setState({
